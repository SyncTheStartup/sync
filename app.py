...
#     redirect_uri='http://localhost:5000/calendar'  
# )
...
#     google_calendar_events = get_google_calendar_events(credentials)

#     # Render the calendar page with events
#     return render_template('calendar.html', events=google_calendar_events)
...
# # Function to get Google Calendar data
...
#     'client_secret_131606957380-u4ikuhues6u5s60dtueah3mgncn9u2u1.apps.googleusercontent.com.json', 
#     scopes=['https://www.googleapis.com/auth/calendar.readonly'],
#     redirect_uri='http://localhost:5000/calendar'  # Ensure this matches your redirect URI
# )
...
#     credentials = flow.credentials
#     google_calendar_data = get_google_calendar(credentials)

#     # Get Google Calendar events
#     google_calendar_events = get_google_calendar_events(credentials)

#     # Render the calendar page with events
#     return render_template('calendar.html', calendar=google_calendar_data, events=google_calendar_events)
